...
async function seed() {
  ...
  for (const p of patientsData) {
    const res = insertPatient.run(
      ...
      p.consent, p.cver, p.cdate, p.cwit,
      p.offset
    );
